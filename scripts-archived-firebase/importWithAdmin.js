...
// Use Node.js environment for Firebase Admin
const admin = require('firebase-admin');

// Initialize Firebase Admin
try {
  // Try to use the FIREBASE_CONFIG_FILE env variable or default path
  const configPath = process.env.FIREBASE_CONFIG_FILE || 
    path.join(__dirname, '../src/firebaseConfig.json');
  ...
  // Try without service account - will use default credentials
  try {
    admin.initializeApp();
