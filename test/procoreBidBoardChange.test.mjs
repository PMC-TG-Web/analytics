...
} from "../src/lib/procoreBidBoardChange.ts";
...
test("unchanged Bid Board projects do not require persistence", () => {
  assert.equal(
    bidBoardPayloadNeedsPersistence(
      { id: "123", updated_at: "2026-07-29T12:00:00Z" },
      { updated_at: "2026-07-29T12:00:00Z", id: "123" },
    ),
    false,
  );
});

test("a Bid Board project returning after being marked missing is persisted", () => {
  assert.equal(
    bidBoardPayloadNeedsPersistence(
      {
        id: "123",
